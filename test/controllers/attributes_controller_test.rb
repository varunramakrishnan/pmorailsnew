...
class AttributesControllerTest < ActionController::TestCase
  ...
  test "should create attribute" do
    assert_difference('Attribute.count') do
      post :create, attribute: { active_status: @attribute.active_status, attribute_key: @attribute.attribute_key, attribute_type: @attribute.attribute_type, attribute_value: @attribute.attribute_value }
    end
  ...
  test "should update attribute" do
    patch :update, id: @attribute, attribute: { active_status: @attribute.active_status, attribute_key: @attribute.attribute_key, attribute_type: @attribute.attribute_type, attribute_value: @attribute.attribute_value }
    assert_redirected_to attribute_path(assigns(:attribute))
  end
